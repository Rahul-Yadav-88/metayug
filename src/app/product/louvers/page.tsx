...
Louvers          </h1>
          ...
          <p className="max-w-md text-base leading-relaxed text-zinc-300">
            Louvers is a versatile façade solution offering three distinct panel types—grooved, perforated, and solid—each engineered to deliver unique aesthetic and functional benefits. This flexible system allows architects and designers to create visually striking façades while addressing essential requirements such as light control, ventilation, and privacy. With its adaptable configurations and refined metal finishes, Louvers enables customized architectural expressions tailored precisely to project-specific needs.
          </p>
        </div>
      </div>
    </div>
