      ...
      // '/p3.png',
        ...
        <div className="relative flex flex-col justify-center gap-6 pl-10">
          ...
          <p className="max-w-md text-base leading-relaxed text-zinc-300">
           Facadewala Pyramid metal facade panels draw inspiration from ancient pyramid geometry, reinterpreted for modern architectural elevations. The precisely engineered 3D metal patterns interact with light and shadow to create a dynamic visual impact throughout the day. Ideal for commercial buildings, luxury exteriors, and signature feature facades, these architectural metal elevation panels combine durability, depth, and a bold contemporary identity for standout projects.
          </p>
        </div>
      </div>
    </div>
