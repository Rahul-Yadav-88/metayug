...
export default function ExquisiteMarbleBathroom() {
  ...
  return (
    <div className="bg-[#1C1C1C] min-h-screen text-white overflow-hidden relative">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-10 border-b border-[#cb972b]/30 pb-10">
          <p className="md:col-span-2 text-white/70 leading-relaxed">
            We craft sleek, modern exterior designs that emphasize clean lines, minimal detailing, and contemporary materials. Our approach blends elegance and functionality to create sophisticated exteriors that make a bold and lasting impression.
          </p>
          ...
          <div className="space-y-6 text-sm">
            <div>
              ...
              >
                Exterior Architectural Design Services
              </motion.p>
            </div>
            ...
            <div>
              ...
              <motion.p
                ...
                transition={{ duration: 0.3 }}
              >
                Olive Palette, Textured Walls, Designer Lighting
              </motion.p>
            </div>
          </div>
        </div>
      ...
      >
        {["/15.jpeg", "/19.png", "/24.png"].map((img, i) => (
          <motion.div
            key={i}
