...
export default function ServicesSection({
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="relative min-h-[110vh] flex items-center px-6 overflow-hidden bg-black"
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          />
          <div className="absolute inset-0 border border-[#cb972b]/30 pointer-events-none" />
        </motion.div>
        ...
        >
          {category && (
            <motion.p
              className="text-[#e5a018] mb-4 tracking-widest uppercase text-sm"
          ...
          {title && (
            <motion.h2
              className="font-serif text-[#cb972b] text-3xl md:text-4xl mb-6 leading-tight"
          ...
          {description && (
            <motion.p
              className="text-[#f9e3aa]/70 mb-10 max-w-xl"
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
