  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-center gap-6 md:gap-12">
        ...
        >
          <ChevronLeft className="w-6 h-6 text-[#cb972b]" />
        </button>

        <div className="flex items-center justify-center gap-4 md:gap-8">
          {/* Left Image - Small */}
          <div
            className="w-32 h-40 md:w-40 md:h-52 rounded-lg overflow-hidden flex-shrink-0 opacity-60 hover:opacity-80 transition-opacity cursor-pointer"
            onClick={goToPrevious}
          >
            <img
          ...
          {/* Center Image - Large */}
          <div className="w-48 h-64 md:w-96 md:h-96 rounded-lg overflow-hidden flex-shrink-0 shadow-2xl">
            <img
        ...
        >
          <ChevronRight className="w-6 h-6 text-[#cb972b]" />
        </button>
      </div>
